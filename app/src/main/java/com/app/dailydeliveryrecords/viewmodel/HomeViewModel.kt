...
class HomeViewModel : ViewModel() {
   ...
   /* private val today = "${calendar.get(Calendar.DATE)}/${
    ...
    private val _todayDelivery: MutableLiveData<Int> = MutableLiveData()
    val todayDelivery: LiveData<Int> = _todayDelivery
    ...
    val deliveryList : MutableLiveData<List<DocumentSnapshot>> = _deliveryList

    private val _deliveryValueList : MutableLiveData<kotlin.collections.List<DocumentSnapshot>> = MutableLiveData()
    val deliveryValueList : MutableLiveData<List<DocumentSnapshot>> = _deliveryValueList
        ...
        db.collection("records")
            ...
            .addOnSuccessListener { documents ->
                ...
                for (document in documents) {
                    ...
                    _todayDelivery.value = (document.data["delivery"] as Long).toInt()
                }
